...
- Last work: Sprint 8 Story 8.4 — v0.1.0 release: tag + GitHub release + multi-arch image publish [sprint]
...
- ADRs touched this session: none. (Previous session: 0008 new — kubeconfig source registry; 0007 re-statused Superseded by 0008.)
